    ...
    <Transition name="fade-up">
        <div v-if="visible" class="flex flex-row justify-between">
            <div class="flex flex-col gap-1 max-w-140 -mt-2">
                ...
                <span class="ml-1.5 text-2xl font-normal text-[#959595] mt-4">Full Stack Software Engineer with expertise on creating innovative ideas that impact your products and make them outstand over anything.</span>
                <div class="flex flex-row mt-12 ml-2 gap-8 items-center align-middle">
                    <div class="flex flex-row gap-4">
                        <SocialButton
                            :social="'instagram'"
                            :url="'https://instagram.com/juanhincapieh'"
                        />
                        <SocialButton
                            :social="'github'"
                            :url="'https://github.com/juanhincapieh'"
                        />
                        <SocialButton
                            :social="'linkedin'"
                            :url="'https://linkedin.com/in/juanhincapieh'"
                        />
                    </div>
                    <div class="bg-[#959595] h-12 w-0.5"></div>
                    <Button
                        :size="'lg'"
                        :variant="'default'"
                        :icon="ChevronRight"
